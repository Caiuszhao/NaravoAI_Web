...
import { CharacterDetailPage, getMockCharacterDetail } from './CharacterDetailPage';
...
export function CharactersTab({
  ...
  useEffect(() => {
    onDetailViewChange?.(selectedCharacter !== null);
  }, [onDetailViewChange, selectedCharacter]);
  ...
  return (
    <div className="w-full h-full bg-[#020202] text-white select-none relative overflow-hidden">
      <div className={`h-full pt-14 pb-28 overflow-y-auto hide-scrollbar ${selectedCharacter ? 'pointer-events-none' : ''}`}>
      ...
      <AnimatePresence>
        {selectedCharacter && (
          <CharacterDetailPage 
            data={getMockCharacterDetail(selectedCharacter)} 
