...
import { Bug, ChevronDown, ChevronUp, ClipboardCopy, Trash2 } from 'lucide-react';
...
export function DemoDebugPanel() {
  ...
  return (
    <div className="fixed bottom-3 left-3 z-[200] flex flex-col items-start gap-1 max-w-[min(100vw-1.5rem,420px)] pointer-events-auto">
