...
export const CUSTOM_LOGO_URL = new URL(
  '../../../assets/3bf85ad3821c19cb83ca7268914f3d9ba7a2eab8.png',
  import.meta.url
).href;
...
export const STORY_CONFIG: DemoScenario = {
  ...
  feedHook:
    'You and your partner race to a jammed shelter gate. Break the lock in 5 seconds before the horde catches you.',
  showcaseHook:
...
export const LEGACY_DEMO_3: DemoScenario = {
  ...
  feedHook:
    'Coming Soon. A lone astronaut gets one unstable relay burst. Your reply decides if he risks a final EVA repair or records a goodbye.',
  showcaseHook:
    'Coming Soon. A lone astronaut drifting on a dying station restores one unstable relay burst. Your reply decides whether he risks one last EVA repair or records a final goodbye.',
  ...
  videos: DEMO3_VIDEOS,
  bgmUrl:
    'https://playable-1257281110.cos.ap-guangzhou.myqcloud.com/story_last_day/demo2/demo2_bgm.mp3',
  playVideoAudio: true,
};
